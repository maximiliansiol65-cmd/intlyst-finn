...
export const ALL_TABS = [
  ...
  { id: "tasks",     to: "/tasks",    label: "Tasks",     Icon: IcoCheck            },
  { id: "alerts",    to: "/alerts",   label: "Alerts",    Icon: IcoBell             },
  { id: "empfehlungen", to: "/ceo",   label: "Empfehlungen", Icon: IcoRocket         },
...
// Standard-Tabs je Abo — ändern sich automatisch beim Plan-Wechsel
export const PLAN_DEFAULTS = {
  trial:         ["dashboard", "tasks", "mehr"],
  standard:      ["dashboard", "tasks", "alerts", "mehr"],
  team_standard: ["dashboard", "analyse", "wachstum", "tasks", "mehr"],
  team_pro:      ["dashboard", "analyse", "wachstum", "tasks", "mehr"],
};
...
export default function BottomTabBar() {
  ...
  const coreIds = ["dashboard", "alerts", "empfehlungen", "mehr"];
