...
import { SkeletonLine, Sheet } from "../components/ui";
...
export default function Mehr() {
  ...
  useEffect(() => { fetchGoals(); fetchTasks(); }, []);
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--s-5)" }}>
        ...
        <div>
          ...
          <div className="card" style={{ overflow: "hidden", padding: 0 }}>
            ...
            {/* Szenarien */}
            <NavRow to="/forecast"  icon={IcoChart} label="Forecast & Prognose"   sub="Umsatz-, Leads- und Conversion-Prognosen mit Szenarien" idx={4} />
            <NavRow to="/szenarien" icon={IcoChart} label="Szenarien & Vergleich" sub="Strategische Szenarien, Prognosen und Frühwarnung" idx={5} />
